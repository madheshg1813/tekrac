...
export function DeviceOrbit() {
  return (
    <div className="relative mx-auto aspect-square w-full max-w-md [--orbit-r:5.5rem] sm:[--orbit-r:8rem] md:[--orbit-r:10.5rem]">
      ...
      {/* center recycle mark */}
      <div className="absolute left-1/2 top-1/2 flex size-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-gradient-to-br from-brand-500 to-brand-700 text-white shadow-lift sm:size-20 md:size-28">
